...
{
    $_REQUEST["REGISTER"]["UF_PHONE"] = $_REQUEST["USER_PHONE"];
    $_REQUEST["REGISTER"]["EMAIL"] = $_REQUEST["USER_EMAIL"];
    $name = explode(' ',$_REQUEST["USER_NAME"]);
    $_REQUEST["REGISTER"]["NAME"] = $name[0];
    $_REQUEST["REGISTER"]["LAST_NAME"] = $name[1];
	...
	else // if there;s no any errors - create user
	{
		...
		$arResult['VALUES']["LID"] = SITE_ID;
                ...
                $arResult['VALUES']["PASSWORD"] = $arResult['VALUES']["CONFIRM_PASSWORD"] = randString(8, $password_chars);
