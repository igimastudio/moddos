...
{
	ShowError(GetMessage("CVP_ERROR_MODULE"));
	die();
}
...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"PARTIAL_PRODUCT_PROPERTIES" => array(
			...
			"PARENT" => "BASKET",
			"NAME" => GetMessage("CATALOG_FILTER_NOVELTY_COUNT"),
			"TYPE" => "STRING",
			"DEFAULT" => "30",
		),
		...
		"IBLOCK_ID" => array(
			"PARENT" => "DATA_SOURCE",
			"NAME" => GetMessage("CVP_IBLOCK_ID"),
			"TYPE" => "STRING",
			"DEFAULT" => '',
			"HIDDEN" => (isset($arCurrentValues['SHOW_FROM_SECTION']) && $arCurrentValues['SHOW_FROM_SECTION'] == "Y" ? "N" : "Y")
		),
