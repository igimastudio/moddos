<?
$MESS["IGIMA_MODDOS_MASSIV_S_DOPOLNITELQ"] = "массив с дополнительной справочной информацией (список статусов, платежных систем, служб доставок.)
        (
                ...
                (
                    [N] => Array // ключ массива - идентификатор статуса
                        (
                            ...
                            [GROUP_ID] => 30		// группа пользователей, имеюща€ права на работу с этим статусом
                        ...
                        (
                            [0] => Array
                                (
                                    ...
                                    [LID] => ru
                                    [DELAY] => N
                                    [NAME] => Ѕитрикс: ”правление сайтом - ћалый бизнес (MySQL/OracleXE/MS SQL Express)
                                    [CAN_BUY] => Y
                                    [MODULE] => catalog
