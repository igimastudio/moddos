...
$MESS["CP_BCS_FILTER_NOVETLY"] = "Показывать новинки";
$MESS["CP_BCS_FILTER_DISCOUNT"] = "Показывать товары со скидкой";
$MESS["CP_BCS_FILTER_NOVETLY_COUNT"] = "Сколько дней товар считается новинкой";
$MESS["IBLOCK_FILTER_SETTINGS"] = "Настройки фильтра";
$MESS["QUICK_VIEW_SETTINGS"] = "Настройки быстрого просмотра";
$MESS["CP_BCS_SHOW_ADV_BLOCK"] = "Показывать рекламный блок";
?>