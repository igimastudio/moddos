...
$arComponentParameters = array(
	"GROUPS" => array(
		"PRICES" => array(
			...
			"NAME" => GetMessage("IBLOCK_FILTER_SETTINGS"),
		),
            "QUICK_VIEW" => array(
			"NAME" => GetMessage("QUICK_VIEW_SETTINGS"),
		),
	),
	"PARAMETERS" => array(
		"AJAX_MODE" => array(),
		...
		"CACHE_GROUPS" => array(
			...
			"DEFAULT" => "Y",
                ...
                "FILTER_NOVELTY" => array(
			"PARENT" => "FILTER_SETTINGS",
			"NAME" => GetMessage("CP_BCS_FILTER_NOVETLY"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
                "FILTER_NOVELTY_COUNT" => array(
			"PARENT" => "FILTER_SETTINGS",
			"NAME" => GetMessage("CP_BCS_FILTER_NOVETLY_COUNT"),
			"TYPE" => "STRING",
			"DEFAULT" => "30",
		),
                "FILTER_DISCOUNT" => array(
			"PARENT" => "FILTER_SETTINGS",
			"NAME" => GetMessage("CP_BCS_FILTER_DISCOUNT"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
                "SHOW_ADV_BLOCK" => array(
			"PARENT" => "QUICK_VIEW",
			"NAME" => GetMessage("CP_BCS_SHOW_ADV_BLOCK"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
	),
