...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		if ($arItem['CATALOG'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS']))
		{
			...
			else
			{
				...
				foreach ($arItem['OFFERS'] as $keyOffer => $arOffer)
				{
					...
					$arOffer['MIN_PRICE'] = $arOffer['RATIO_PRICE'];
					$arOffer['MIN_PRICE']['CATALOG_MEASURE_RATIO'] = $arOffer['CATALOG_MEASURE_RATIO'];
					$arOffer['MIN_PRICE']['CATALOG_MEASURE'] = $arOffer['CATALOG_MEASURE'];
					$arOffer['MIN_PRICE']['CATALOG_MEASURE_NAME'] = $arOffer['CATALOG_MEASURE_NAME'];
					$arOffer['MIN_PRICE']['~CATALOG_MEASURE_NAME'] = $arOffer['~CATALOG_MEASURE_NAME'];
					unset($arOffer['RATIO_PRICE']);
		...
		{
			if (1 === $arItem['CATALOG_MEASURE_RATIO'])
			{
				$arItem['RATIO_PRICE'] = array(
					'VALUE' => $arItem['MIN_PRICE']['VALUE'],
					'DISCOUNT_VALUE' => $arItem['MIN_PRICE']['DISCOUNT_VALUE'],
					'PRINT_VALUE' => $arItem['MIN_PRICE']['PRINT_VALUE'],
					'PRINT_DISCOUNT_VALUE' => $arItem['MIN_PRICE']['PRINT_DISCOUNT_VALUE'],
					'DISCOUNT_DIFF' => $arItem['MIN_PRICE']['DISCOUNT_DIFF'],
					'PRINT_DISCOUNT_DIFF' => $arItem['MIN_PRICE']['PRINT_DISCOUNT_DIFF'],
					'DISCOUNT_DIFF_PERCENT' => $arItem['MIN_PRICE']['DISCOUNT_DIFF_PERCENT'],
			...
			{
				$arItem['RATIO_PRICE'] = array(
					'VALUE' => $arItem['MIN_PRICE']['VALUE']*$arItem['CATALOG_MEASURE_RATIO'],
					'DISCOUNT_VALUE' => $arItem['MIN_PRICE']['DISCOUNT_VALUE']*$arItem['CATALOG_MEASURE_RATIO'],
					'CURRENCY' => $arItem['MIN_PRICE']['CURRENCY']
				);
				$arItem['RATIO_PRICE']['PRINT_VALUE'] = (
					$boolNewCurrencyFormat
					? CCurrencyLang::CurrencyFormat($arItem['RATIO_PRICE']['VALUE'], $arItem['RATIO_PRICE']['CURRENCY'], true)
					: CurrencyFormat($arItem['RATIO_PRICE']['VALUE'], $arItem['RATIO_PRICE']['CURRENCY'])
				);
				$arItem['RATIO_PRICE']['PRINT_DISCOUNT_VALUE'] = (
					$boolNewCurrencyFormat
					? CCurrencyLang::CurrencyFormat($arItem['RATIO_PRICE']['DISCOUNT_VALUE'], $arItem['RATIO_PRICE']['CURRENCY'], true)
					: CurrencyFormat($arItem['RATIO_PRICE']['DISCOUNT_VALUE'], $arItem['RATIO_PRICE']['CURRENCY'])
				);
				if ($arItem['MIN_PRICE']['VALUE'] == $arItem['MIN_PRICE']['DISCOUNT_VALUE'])
				{
					$arItem['RATIO_PRICE']['DISCOUNT_DIFF'] = 0;
					$arItem['RATIO_PRICE']['DISCOUNT_DIFF_PERCENT'] = 0;
					$arItem['RATIO_PRICE']['PRINT_DISCOUNT_DIFF'] = (
						$boolNewCurrencyFormat
						? CCurrencyLang::CurrencyFormat(0, $arItem['RATIO_PRICE']['CURRENCY'], true)
						: CurrencyFormat(0, $arItem['RATIO_PRICE']['CURRENCY'])
					);
				}
				else
				{
					$arItem['RATIO_PRICE']['DISCOUNT_DIFF'] = $arItem['RATIO_PRICE']['VALUE'] - $arItem['RATIO_PRICE']['DISCOUNT_VALUE'];
					$arItem['RATIO_PRICE']['DISCOUNT_DIFF_PERCENT'] = 100*$arItem['RATIO_PRICE']['DISCOUNT_DIFF']/$arItem['RATIO_PRICE']['VALUE'];
					$arItem['RATIO_PRICE']['PRINT_DISCOUNT_DIFF'] = (
						$boolNewCurrencyFormat
						? CCurrencyLang::CurrencyFormat($arItem['RATIO_PRICE']['DISCOUNT_DIFF'], $arItem['RATIO_PRICE']['CURRENCY'], true)
						: CurrencyFormat($arItem['RATIO_PRICE']['DISCOUNT_DIFF'], $arItem['RATIO_PRICE']['CURRENCY'])
					);
				}
			}
			$arItem['MIN_PRICE'] = $arItem['RATIO_PRICE'];
			unset($arItem['RATIO_PRICE']);
		}
