...
$MESS["IGIMA_MODDOS_NEXT_PAGE"] = "следующая страница";
$MESS["IGIMA_MODDOS_PREV_PAGE"] = "предыдущая страница";
$MESS["IGIMA_MODDOS_NO_ITEMS"] = "К сожалению в данном разделе товар отсутствует, попробуйте воспользоваться строкой поиска";
?>